...
int main(){
    ...
    do{
        ...
        switch(opcion){
            ...
            case 3: 
                std::cout << contarNiveles(arbol) << " Niveles encontrados en el arbol." << std::endl;
            break;

            case 4: 
                contarNodos(arbol);
                std::cout << contador_nodos << " Nodos encontrados." << std::endl;
                contador_nodos = 0;
            break;

            case 5: 
                sumarNodos(arbol);
                std::cout << "La sumatoria es igual a: " << sumatoria_nodos << std::endl;
                sumatoria_nodos = 0;
            break;
